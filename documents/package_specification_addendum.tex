...
\begin{center}
  ...
  {\large Model-matrix and initialization implementation addendum}
\end{center}
...
The model-matrix and initialization infrastructure is covered by automated
tests implemented with the \texttt{tinytest} package. Separate test files
cover model matrices, misclassification expansion, cross-component
...
All tests exercise the implemented behavior through \texttt{crc\_fit()} and
pass against the built and installed package.
...
The model-matrix and initialization infrastructure and their automated tests
