...
stability for right-tail calculations. The complete suite now contains 169
passing assertions.
...
\begin{enumerate}
  \item Validate fitting and prediction against one deterministic replication
  of the accompanying IAOS simulation, comparing overall and occupation-level
  estimates with the original implementation before running a broader study.
...
implementation. The next development step is integration validation against the
IAOS simulation implementation and data. The existing automated tests establish
the fitting, prediction, matrix, alignment, iteration, and convergence invariants
